...
SYSTEMS = {
    ...
    # DDR5, Arrow Lake, 1 channel, 1 DPC, 1 ranks, 32GB.
    "arrow_1ch_1dpc_1rank_32gb": {
        "offset_bits": 6,
        "channel":     [0x82600],
        "rank":        [],
        "bank_group":  [0x42102100, 0x84204000, 0x108408000],
    ...
    # DDR4, Intel Cascade Lake (scal23), 1 channel, 1 DPC, 2 ranks, 32GB.
    "cascade_4ch_1dpc_2rank_32gb": {
        "offset_bits": 6,
        "channel":     [0x100,0x1000000000 ],
        "rank":        [0x4000],
        "bank_group":  [0x40, 0x80000  ],
        "bank":        [0x100000, 0x200000],
        "row":         0xfffc70000,
        "column":      0xbe80,
    },

    # DDR4, Intel Cascade Lake (scal32), 1 channel, 1 DPC, 2 ranks, 32GB.
    "ice_1ch_1dpc_2rank_x8_16gb": {
        "offset_bits": 6,
        "channel":     [],
        "rank":        [0x2000],
        "bank_group":  [0x200040,0x440000],
        "bank":        [0x880000,0x1100000],
        "row":         0x3ffe38000,
        "column":      0x5f80,
    },
}
